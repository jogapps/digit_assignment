...
import 'package:digit_assignment/models/response/response_model.dart';
import 'package:digit_assignment/models/role_actions/role_actions_model.dart';
...
class SecureStore {
  ...
  Future setLocalizations(
    LocalizationModel localizationList,
    String locale,
  ) async {
