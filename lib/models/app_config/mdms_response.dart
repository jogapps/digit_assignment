...
part 'mdms_response.freezed.dart';
part 'mdms_response.g.dart';
...
class MdmsResponseModel with _$MdmsResponseModel {
  ...
  factory MdmsResponseModel.fromJson(Map<String, dynamic> json) =>
...
class AppConfig with _$AppConfig {
  const factory AppConfig({
    @JsonKey(name: 'appConfig') required List<AppConfigListItems>? appConfig,
  }) = _AppConfig;
...
class AppConfigListItems with _$AppConfigListItems {
  ...
  factory AppConfigListItems.fromJson(Map<String, dynamic> json) =>
      _$AppConfigListItemsFromJson(json);
}

@freezed
class GenderOptions with _$GenderOptions {
  factory GenderOptions({required String name, required String code}) =
      _GenderOptions;
...
class InterfacesList with _$InterfacesList {
  const factory InterfacesList({
    @JsonKey(name: 'interfaces') required List<Interfaces>? interfaces,
  }) = _InterfacesList;

  factory InterfacesList.fromJson(Map<String, dynamic> json) =>
