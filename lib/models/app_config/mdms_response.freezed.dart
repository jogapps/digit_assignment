...
abstract class $InterfacesListCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'interfaces') List<Interfaces>? interfaces});
}
...
class _$InterfacesListImpl implements _InterfacesList {
  const _$InterfacesListImpl(
      {@JsonKey(name: 'interfaces')
      required final List<Interfaces>? interfaces})
...
abstract class _InterfacesList implements InterfacesList {
  const factory _InterfacesList(
      {@JsonKey(name: 'interfaces')
      required final List<Interfaces>? interfaces}) = _$InterfacesListImpl;
